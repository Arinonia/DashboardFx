...
public class BarButton extends GridPane {
    ...
    public BarButton(final String text, boolean isCurrent) {
        ...
        this.setStyle("-fx-border-width: 1px; -fx-border-color: rgb(149, 104, 210);");
        ...
        iconView.setTranslateX(4.0D);
        iconView.setFitHeight(32.0D);
        iconView.setFitWidth(32.0D);
        ...
        this.setOnMouseEntered(e -> {
            this.setStyle("-fx-border-width: 1px; -fx-border-color: rgb(149, 104, 210); -fx-background-color: rgba(255, 255, 255, 0.2);");
        });
